...
public class Welcome extends JFrame {
    ...
    private void showWelcomeMessage(String name) {
        ...
        JLabel additionalTextLabel = new JLabel("<html><span style='background-color: #000000; font-style: italic;'>Are you ready to unveil algorithms and craft solutions?</span></html>");
